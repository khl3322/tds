...
override_doctype_class = {
	"Payment Entry": "tds_compliance.custom_methods.custom_payment_entry.CustomPaymentEntry",
	"Purchase Invoice": "tds_compliance.custom_methods.custom_purchase_invoice.CustomPurchaseInvoice",
}
